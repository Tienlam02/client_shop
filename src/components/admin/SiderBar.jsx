...
const SiderBar = () => {
  return (
    <div className=" z-[10000] mt-5 ml-5    ">
      <p className=" z-[10000] flex justify-center text-4xl border-b pb-4 shadow-md">
        <NavLink to="/">
          <img
      ...
      <ul className=" z-[10000] flex mt-10 flex-col gap-5">
        <li>
          <NavLink
            className=" z-[10000] flex items-center gap-2"
            to="/admin/dashboard"
          >
            <CiHome />
            Dashboard
        ...
        <li>
          <div className=" z-[10000] flex items-center gap-2">
            <CiSettings size={20} /> Quản lý đơn hàng
          </div>
          <ul className=" z-[10000] ml-5 space-y-4 mt-4">
            <li>
              <NavLink
                className=" z-[10000] flex items-center gap-2"
                to="/admin/list-order"
        ...
        <li>
          <div className=" z-[10000] flex items-center gap-2">
            <CiSettings size={20} /> Quản lý bài viết
          </div>
          <ul className=" z-[10000] ml-5 space-y-4 mt-4">
            <li>
              <NavLink
          ...
          <ul className=" z-[10000] ml-5 space-y-4 mt-4">
            <li>
              <NavLink
                ...
                to="/admin/list-user"
              >
                <PiUserListThin /> Phân quyền người dùng
              </NavLink>
            </li>
          </ul>
        </li>
